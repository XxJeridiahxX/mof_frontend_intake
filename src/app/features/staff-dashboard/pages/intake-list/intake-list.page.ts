...
const SECTIONS: SectionDef[] = [
  {
    ...
    fields: [
      ...
      { key: 'maritalStatus', label: 'Marital Status', type: 'select', options: ['Single','Married','Divorced','Widowed','Separated','Domestic partner'] },
      { key: 'housingType', label: 'Housing Type' },
      { key: 'communicationDiff', label: 'Comm. Difficulty', type: 'select', options: ['Yes','No'] },
      { key: 'communicationDesc', label: 'Comm. Description' },
      { key: 'employmentStatus', label: 'Employment', type: 'select', options: ['Employed','Unemployed','Retired','Student'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'primaryContactNum', label: 'Primary Contact', type: 'select', options: ['Cell','Home','Work'] },
      { key: 'bestContactMethod', label: 'Best Contact', type: 'select', options: ['Phone Call','Text','Email'] },
      { key: 'mailingStreet', label: 'Mailing Street' }, { key: 'mailingApt', label: 'Apt/Suite' },
      { key: 'mailingCity', label: 'City' }, { key: 'mailingState', label: 'State' }, { key: 'mailingZip', label: 'ZIP' },
      { key: 'billingSame', label: 'Billing = Mailing', type: 'select', options: ['Yes','No'] },
      { key: 'billingStreet', label: 'Billing Street' }, { key: 'billingApt', label: 'Billing Apt' },
      { key: 'billingCity', label: 'Billing City' }, { key: 'billingState', label: 'Billing State' }, { key: 'billingZip', label: 'Billing ZIP' },
    ]
  },
  {
    key: 'careTeamForm', label: 'Care Team', icon: 'groups',
    fields: [
      { key: 'emergFirst', label: 'Emerg. First' }, { key: 'emergLast', label: 'Emerg. Last' },
      { key: 'emergRel', label: 'Emerg. Relationship' }, { key: 'emergPhone', label: 'Emerg. Phone' },
      { key: 'familyFirst', label: 'Support First' }, { key: 'familyLast', label: 'Support Last' },
      { key: 'familyRel', label: 'Support Relationship' }, { key: 'familyPhone', label: 'Support Phone' },
      { key: 'pcpFirst', label: 'PCP First' }, { key: 'pcpLast', label: 'PCP Last' },
      { key: 'pcpPractice', label: 'PCP Practice' }, { key: 'pcpPhone', label: 'PCP Phone' }, { key: 'pcpFax', label: 'PCP Fax' },
      { key: 'refFirst', label: 'Referring First' }, { key: 'refLast', label: 'Referring Last' },
      { key: 'refSpecialty', label: 'Ref. Specialty' }, { key: 'refPractice', label: 'Ref. Practice' },
      { key: 'refPhone', label: 'Ref. Phone' }, { key: 'refFax', label: 'Ref. Fax' },
    ]
  },
  {
    ...
    fields: [
      // Primary
      { key: 'primaryCarrier', label: 'Primary Carrier' }, { key: 'subscriberId', label: 'Member ID' },
      { key: 'groupNumber', label: 'Group #' },
      { key: 'relationship', label: 'Relationship', type: 'select', options: ['Self','Spouse','Child','Other'] },
      { key: 'policyHolderFirstName', label: 'Holder First' }, { key: 'policyHolderLastName', label: 'Holder Last' },
      { key: 'policyHolderDob', label: 'Holder DOB', type: 'date' },
      // Secondary
      { key: 'secCarrier', label: 'Sec. Carrier' }, { key: 'secSubscriberId', label: 'Sec. Member ID' },
      { key: 'secGroupNumber', label: 'Sec. Group #' }, { key: 'secRelationship', label: 'Sec. Relationship' },
      { key: 'secPolicyHolderFirstName', label: 'Sec. Holder First' }, { key: 'secPolicyHolderLastName', label: 'Sec. Holder Last' },
      { key: 'secPolicyHolderDob', label: 'Sec. Holder DOB', type: 'date' },
      // Tertiary
      { key: 'terCarrier', label: 'Ter. Carrier' }, { key: 'terSubscriberId', label: 'Ter. Member ID' },
      { key: 'terGroupNumber', label: 'Ter. Group #' }, { key: 'terRelationship', label: 'Ter. Relationship' },
      { key: 'terPolicyHolderFirstName', label: 'Ter. Holder First' }, { key: 'terPolicyHolderLastName', label: 'Ter. Holder Last' },
      { key: 'terPolicyHolderDob', label: 'Ter. Holder DOB', type: 'date' },
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      { key: 'localName', label: 'Local Pharmacy' }, { key: 'localPhone', label: 'Local Phone' },
      { key: 'localStreet', label: 'Local Street' }, { key: 'localCityStateZip', label: 'City, State, ZIP' },
      { key: 'mailName', label: 'Mail Pharmacy' }, { key: 'mailAccount', label: 'Mail Account/Phone' },
    ]
  },
  {
    key: 'socialHistoryForm', label: 'Social History', icon: 'diversity_3',
    fields: [
      { key: 'drinksAlcohol', label: 'Alcohol Use', type: 'select', options: ['Yes','No'] },
      { key: 'alcoholFrequency', label: 'Alcohol Frequency', type: 'select', options: ['Daily','Weekly','Monthly','Socially'] },
      { key: 'alcoholDrinks', label: 'Drinks/Session' },
      { key: 'usesTobacco', label: 'Tobacco Use', type: 'select', options: ['Yes','No'] },
      { key: 'tobaccoTypes', label: 'Tobacco Types' },
      { key: 'tobaccoFrequency', label: 'Tobacco Frequency' },
      { key: 'tobaccoStartYear', label: 'Tobacco Start Year' },
      { key: 'usedTobaccoPast', label: 'Past Tobacco', type: 'select', options: ['Yes','No'] },
      { key: 'tobaccoPastStart', label: 'Tobacco Past Start' }, { key: 'tobaccoPastStop', label: 'Tobacco Past Stop' },
      { key: 'usesDrugs', label: 'Drug Use', type: 'select', options: ['Yes','No'] },
      { key: 'drugsTypes', label: 'Drug Types' }, { key: 'drugsStartYear', label: 'Drug Start Year' },
      { key: 'usedDrugsPast', label: 'Past Drug Use', type: 'select', options: ['Yes','No'] },
      { key: 'drugsPastStart', label: 'Drug Past Start' }, { key: 'drugsPastStop', label: 'Drug Past Stop' },
      { key: 'exercises', label: 'Exercise', type: 'select', options: ['Yes','No'] },
      { key: 'exerciseType', label: 'Exercise Type' }, { key: 'exerciseFrequency', label: 'Exercise Frequency' },
      { key: 'dietRating', label: 'Diet Rating', type: 'select', options: ['Excellent','Good','Fair','Poor'] },
    ]
  },
];
